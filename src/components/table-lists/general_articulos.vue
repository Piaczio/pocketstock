          ...
          <template v-slot:default>
            ...
            <tbody>
              <tr v-for="item in articulosArray" :key="item.itemid">
                ...
                <td class="table-dist">{{ item.nombre_categoria }}</td>
    ...
    mounted() {
      axios
        ...
        .then((response) => {
          ...
          console.log("this pre fetch -> ", articulos.data);
          articulos.forEach((element) => {
            ...
            console.log("this in fetch -> ", datos);
            if (!datos) return;
            this.articulosArray.push(datos);
          });
          console.log("this -> ", this.articulosArray);
        })
